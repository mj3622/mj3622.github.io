...
description: 记录 GitHub Personal Access Token 的创建步骤与权限配置
tags: [GitHub, API, 工具]
category: 经验分享
draft: false
---

调用 [GitHub API](https://docs.github.com/en/rest/quickstart?apiVersion=2022-11-28) 前，需要先创建 Personal Access Token 并配置权限。下面记录具体步骤。
