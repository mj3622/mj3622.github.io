...
description: 记录利用 RSS 订阅和自动化工具追踪动画更新的方法
...
RSS 可以集中订阅资源更新，不必逐个打开网站检查

# 2. 软件准备

下面使用 qBittorrent 订阅并下载 RSS 资源。其他同时支持 RSS 和下载规则的软件也可以按相同步骤配置。
...
创建下载规则后，选择需要监控的源并设置过滤条件。例如字幕组同时发布简体和繁体版本时，可以只保留简体关键词。右侧列表会实时显示过滤结果，方便调整规则
...
可能是网络访问受限，可以尝试修改[代理服务器配置](#23-配置代理服务器)
相关介绍
